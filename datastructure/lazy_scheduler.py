...
#         job_waiting[rear] = job
# #    print("after append", job, front, rear, job_waiting)
#     return front, rear
...
# def display_queue(front, rear, job_waiting, maximum_waiting):
#     if front == -1:
#         print("Queue is empty")
#     elif rear >= front:
#         print("Elements in the circular queue are:", end=" ")
#         for i in range(front, rear + 1):
#             print(job_waiting[i], end=" ")
#         print()
#     else:
#         print("Elements in the circular queue are:", end=" ")
#         for i in range(front, maximum_waiting):
#             print(job_waiting[i], end=" ")
#         for i in range(0, rear + 1):
#             print(job_waiting[i], end=" ")
#         print()

# def manage_job_with_maximum_waiting_bak(job_list, minute_per_cycle, maximum_waiting):
#     job_segment = job_list.strip().split(',')
#     job_startings = {}
#     for i in range(len(job_segment) // 3):
#         name = job_segment[i * 3]
