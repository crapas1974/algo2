...
def count_and_path_bottom_up(m, n):
    ...
    for i in range(1, m):
        for j in range(1, n):
            dp[i][j] = dp[i - 1][j] + dp[i][j - 1]
            paths[i][j] = [path + 'R' for path in paths[i - 1][j]] + [path + 'D' for path in paths[i][j - 1]]
...
def main():
    testcases = [(3, 2), (2, 3), (6, 3), (1, 100), (100, 1), (15, 25), (25, 25), (25, 15), (100, 150), (500, 10), (500, 495), (10, 10)]
