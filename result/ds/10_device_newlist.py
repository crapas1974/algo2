...
def node_of(head: Device, model_name: str) -> Device:
    cur = head
    while cur != None:
...
def main():
    ...
    node_A4_before = before_node(node_of(head_a, 'A4'))
    print(nodes_in_list(node_A4_before))
    print(nodes_in_list(reverse(node_A4_before)))
    ...
    node_C6_before = before_node(node_of(head_c, 'C6'))
    print(nodes_in_list(node_C6_before))
    print(nodes_in_list(reverse(node_C6_before)))
