...
def get_testcases():
    test1 = "-1,3,6,1,0,2,-8"
    test2 = "-50,1,1,1,1,1,1,-3,3"
    test3 = "68,13,80,n,45,74,79,23,48,n,76,n,n,n,31,n,58,n,n,n,37,51,n,36"
    ...
    testcases = []
    for data in testcases_data:
        testcases.append(build_binary_tree(data))
